...
**1.合并两个有序链表**
[点击这里跳转](https://leetcode.cn/problems/merge-two-sorted-lists/)
```cpp
...
**2.分隔链表**
[点击这里跳转](https://leetcode.cn/problems/partition-list/description/)
